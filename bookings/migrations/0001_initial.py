# Generated by Django 5.1.7 on 2025-06-15 07:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Ожидание', 'Ожидание'), ('Подтверждено', 'Подтверждено'), ('Отменено', 'Отменено')], default='Ожидание', max_length=20)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='Пользователь')),
                ('room', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='bookings.room', verbose_name='Комната')),
            ],
        ),
    ]
